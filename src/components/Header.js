    ...
    <>
      <header className="fixed top-0 left-0 w-full bg-white border-b-[1px] z-50">
        <div className="p-4 max-w-4xl mx-auto  flex items-center justify-between ">
          ...
          <div>
            <div className="hidden sm:block p-2 rounded-3xl bg-gray-100 items-center">
          ...
          {user ? (
            <>
              <div className="flex items-center text-slate-800 text-4xl gap-3">
                <NavLink to="/">
                  <HomeIcon />
                </NavLink>
                <div>
                ...
                {user ? (
                  ...
                  >
                    <img
                      className="h-10 p-0.5 md:border-[1px] border-emerald-500 rounded-full aspect-square"
                      // src={
                    ...
                    />
                    {menuOpen && (
                      <div className="absolute z-20 -bottom-5 w-[200px] right-0 translate-y-full bg-white shadow rounded text-xl">
